...
public class SendSMS2 implements SmsEventListener {
    ...
    public SendSMS2(String text)
    {
        ...
        String smsUsername = "ovochevarka@gmail.com";
        String smsPassword = "kege";
        ...
        sms.setRecipient( "380977760071" );
        
        this.transceiver.send( sms );
    }
 
    // Just make new instance of this class.
    //public static void main( String[] args ){ new SendSMS2(); }
